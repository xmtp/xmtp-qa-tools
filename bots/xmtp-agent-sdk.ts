...
import {
  ...
  withFilter,
  type AgentContext,
  type MessageContext as AgentMessageContext,
  type Client,
  type Conversation,
  type DecodedMessage,
  type Dm,
...
/**
 * Enhanced message context with analysis results
 */
export interface MessageContext extends AgentMessageContext {
  isDm: boolean;
...
/**
 * Message handler callback type for Agent SDK
 */
