...
describe(testName, () => {
  ...
  it("REAL SCENARIO: client2 passively listens, client1 sends - NO POLLING", async () => {
      ...
      (async () => {
        try {
          for await (const message of stream) {
            ...
            console.log("");
            console.log("┌─────────────────────────────────────────────────────────────────┐");
            console.log("│  📋 UNIQUE IDENTIFIERS (for DataDog/DD correlation)            │");
            console.log("├─────────────────────────────────────────────────────────────────┤");
            ...
            console.log(`│  sentAt (from msg):   ${message.sentAt?.toISOString?.() || message.sentAt}  │`);
            console.log(`│  sentAtNs:            ${message.sentAtNs}                  │`);
            console.log("└─────────────────────────────────────────────────────────────────┘");
            console.log("");
            console.log("┌─────────────────────────────────────────────────────────────────┐");
            ...
            // Also log a raw JSON dump for debugging
            console.log("");
            console.log("━━━━━━━━━━━━ RAW MESSAGE OBJECT (for DD correlation) ━━━━━━━━━━━━");
    ...
    console.log("");
    console.log("┌─────────────────────────────────────────────────────────────────┐");
    console.log("│  🔑 SENDER IDENTIFIERS (for DD correlation)                     │");
    console.log("├─────────────────────────────────────────────────────────────────┤");
    console.log(`│  Message ID returned: ${sendResult}`);
    console.log(`│  Group ID:            ${group.id}`);
    console.log(`│  Sender InboxID:      ${client1.inboxId}`);
    console.log(`│  Send Time (ms):      ${sendTime}`);
    console.log(`│  Send Time (ISO):     ${sendTimeISO}`);
    console.log("└─────────────────────────────────────────────────────────────────┘");
