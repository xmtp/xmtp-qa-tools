...
describe(testName, () => {
  ...
  it("browser automation: conversation stream with message", async () => {
  ...
  it("browser automation: conversation stream without message", async () => {
    const newGroup = await creator.client.conversations.newGroup(
      getRandomInboxIds(4),
      {
  ...
  it("browser automation: newDm and message stream", async () => {
  ...
  it("browser automation: newGroup and message stream", async () => {
  ...
  it(
    "browser automation: conversation stream when creating the group",
    async () => {
  ...
  it(
    "browser automation: conversation stream for new member",
    async () => {
  ...
  it("browser automation: new installation and message stream", async () => {
