...
export const VersionList = [
  {
    ...
    Dm: Dm511,
    Group: Group511,
    nodeSDK: "5.1.1", // SDK version
    nodeBindings: "1.8.1", // Bindings version
...
{
  "dependencies": {
    "@xmtp/node-sdk-5.1.1": "npm:@xmtp/node-sdk@5.1.1",
    "@xmtp/node-bindings-1.8.1": "npm:@xmtp/node-bindings@1.8.1"
  }
}
```
...
yarn test performance --nodeSDK 5.1.1 # custom version
